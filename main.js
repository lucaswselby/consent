...
const datePack = ["watch Chicago", "watch Dimension 20", "watch a Dropout show", "watch Invincible", "watch Superstore", "watch Zombies", "write", "sex", "listen to The Judgies", "play HPHB", "research local activities", "play Lego HP", "write music", "Legos", "play a board game", "watch Sex Education", "cook", "Pok&eacute;mon Go", "plan a wedding"];
