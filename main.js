...
const datePack = ["watch Star vs. the Forces of Evil", "watch Stranger Things", "watch Dimension 20", "watch a Dropout show", /*"watch Steven Universe", "watch Gravity Falls", */"work on Sai's gift", "hang pictures", "write", "sex", "listen to The Judgies", "play HPHB", "research local activities", "play Lego HP", "write music", "Legos", "play a board game"];
